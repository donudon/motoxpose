...
class GalleryDetailController extends BaseController {
	...
	*/
	public function getIndex($link){
		...
		$gallery = MsGallery::where("link",$link)->get();
		$title = "MotoXpose - Blogs";
		$data = MsSlider::paginate(4);
		return View::make('galleryDetail', array('title'=>$title, 'data'=>$data, 'gallery'=>$gallery));
	}
